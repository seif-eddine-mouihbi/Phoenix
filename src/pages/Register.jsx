    ...
    <>
      ...
      <div className="relative w-screen h-dvh p-2 grid grid-cols-1 lg:grid-cols-[1fr,1.2fr] lg:gap-2">
        <div className="flex flex-col p-4">
          ...
          <p className="text-bodyMedium mt-auto mx-auto text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant lg:mx-0">
            &copy; 2025 Seif Eddine Mouihbi, All Right Reserved
          </p>
        </div>
